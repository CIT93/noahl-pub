...
const createTableButtons = (data, index) => {
    ...
    editButton.addEventListener('click', () => {
        ...
        FORM.homePurchase.value = data[index].homePurchases;
        FORM.waste.value = data[index].waste;

        FORM.glass.checked = data[index].recycling.glass;
        FORM.plastic.checked = data[index].recycling.plastic;
        FORM.paper.checked = data[index].recycling.paper;
        FORM.aluminium.checked = data[index].recycling.aluminium;
